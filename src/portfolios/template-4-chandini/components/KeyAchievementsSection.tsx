    ...
    <div className="container mx-auto px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-base text-muted-foreground max-w-xl mx-auto">Measurable outcomes from enterprise delivery.</p>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {keyAchievements.map((text, i) => (
            <Card key={i} className="rounded-lg border border-border/70 bg-card shadow-sm hover:shadow-lg hover:-translate-y-1 hover:border-[hsl(var(--primary))]/25 transition-all duration-200">
